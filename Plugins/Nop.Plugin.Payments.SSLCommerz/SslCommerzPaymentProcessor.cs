...
namespace Nop.Plugin.Payments.SSLCommerz
{
    ...
    public class SslCommerzPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        private string GetSSLCommerzUrl()
        {
            ...
            return _sslCommerzPaymentSettings.UseSandbox ? " https://sandbox.sslcommerz.com/gwprocess/v3/process.php" : "https://securepay.sslcommerz.com/gwprocess/v3/process.php";            
        }
        ...
        private string GetSSLCommerzValidationUrl()
        {
            ...
            return _sslCommerzPaymentSettings.UseSandbox ? "https://sandbox.sslcommerz.com/validator/api/validationserverAPI.php" : "https://securepay.sslcommerz.com/validator/api/validationserverAPI.php";
