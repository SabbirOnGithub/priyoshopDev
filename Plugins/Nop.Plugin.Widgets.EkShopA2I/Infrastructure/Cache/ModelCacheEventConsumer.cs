...
namespace Nop.Plugin.Misc.EkShopA2I.Infrastructure.Cache
{
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string SEARCH_CATEGORIES_MODEL_KEY = "Nop.Bswebapi.pres.search.categories-{0}-{1}-{2}";

//        public const string SEARCH_CATEGORIES_PATTERN_KEY = "Nop.Bswebapi.pres.search.categories";
...
//        /// {3} : current store ID
//        /// </remarks>
//        public const string MANUFACTURER_NAVIGATION_MODEL_KEY =
//            "Nop.Bswebapi.pres.manufacturer.navigation-{0}-{1}-{2}-{3}";

//        public const string MANUFACTURER_NAVIGATION_PATTERN_KEY = "Nop.Bswebapi.pres.manufacturer.navigation";

//        /// <summary>
//        /// Key for VendorNavigationModel caching
//        /// </summary>
//        public const string VENDOR_NAVIGATION_MODEL_KEY = "Nop.Bswebapi.pres.vendor.navigation";

//        public const string VENDOR_NAVIGATION_PATTERN_KEY = "Nop.Bswebapi.pres.vendor.navigation";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_KEY =
//            "Nop.Bswebapi.pres.manufacturer.hasfeaturedproducts-{0}-{1}-{2}";

//        public const string MANUFACTURER_HAS_FEATURED_PRODUCTS_PATTERN_KEY =
//            "Nop.Bswebapi.pres.manufacturer.hasfeaturedproducts";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string CATEGORY_NAVIGATION_MODEL_KEY = "Nop.Bswebapi.pres.category.navigation-{0}-{1}-{2}";

//        public const string CATEGORY_NAVIGATION_PATTERN_KEY = "Nop.Bswebapi.pres.category.navigation";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string CATEGORY_MENU_MODEL_KEY = "Nop.Bswebapi.pres.category.menu-{0}-{1}-{2}";

//        public const string CATEGORY_MENU_PATTERN_KEY = "Nop.Bswebapi.pres.category.menu";
...
//        /// {2} : category ID
//        /// </remarks>
//        public const string CATEGORY_NUMBER_OF_PRODUCTS_MODEL_KEY =
//            "Nop.Bswebapi.pres.category.numberofproducts-{0}-{1}-{2}";

//        public const string CATEGORY_NUMBER_OF_PRODUCTS_PATTERN_KEY = "Nop.Bswebapi.pres.category.numberofproducts";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string CATEGORY_HAS_FEATURED_PRODUCTS_KEY =
//            "Nop.Bswebapi.pres.category.hasfeaturedproducts-{0}-{1}-{2}";

//        public const string CATEGORY_HAS_FEATURED_PRODUCTS_PATTERN_KEY =
//            "Nop.Bswebapi.pres.category.hasfeaturedproducts";
...
//        /// {3} : language ID
//        /// </remarks>
//        public const string CATEGORY_BREADCRUMB_KEY = "Nop.Bswebapi.pres.category.breadcrumb-{0}-{1}-{2}-{3}";

//        public const string CATEGORY_BREADCRUMB_PATTERN_KEY = "Nop.Bswebapi.pres.category.breadcrumb";
...
//        /// {4} : is connection SSL secured (included in a category picture URL)
//        /// </remarks>
//        public const string CATEGORY_SUBCATEGORIES_KEY = "Nop.Bswebapi.pres.category.subcategories-{0}-{1}-{2}-{3}-{4}";

//        public const string CATEGORY_SUBCATEGORIES_PATTERN_KEY = "Nop.Bswebapi.pres.category.subcategories";
...
//        /// {3} : is connection SSL secured (included in a category picture URL)
//        /// </remarks>
//        public const string CATEGORY_HOMEPAGE_KEY = "Nop.Bswebapi.pres.category.homepage-{0}-{1}-{2}-{3}";

//        public const string CATEGORY_HOMEPAGE_PATTERN_KEY = "Nop.Bswebapi.pres.category.homepage";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string CATEGORY_CHILD_IDENTIFIERS_MODEL_KEY =
//            "Nop.Bswebapi.pres.category.childidentifiers-{0}-{1}-{2}";

//        public const string CATEGORY_CHILD_IDENTIFIERS_PATTERN_KEY = "Nop.Bswebapi.pres.category.childidentifiers";
...
//        /// {3} : current store ID
//        /// </remarks>
//        public const string PRODUCT_BREADCRUMB_MODEL_KEY = "Nop.Bswebapi.pres.product.breadcrumb-{0}-{1}-{2}-{3}";

//        public const string PRODUCT_BREADCRUMB_PATTERN_KEY = "Nop.Bswebapi.pres.product.breadcrumb";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string PRODUCTTAG_BY_PRODUCT_MODEL_KEY = "Nop.Bswebapi.pres.producttag.byproduct-{0}-{1}-{2}";

//        public const string PRODUCTTAG_BY_PRODUCT_PATTERN_KEY = "Nop.Bswebapi.pres.producttag.byproduct";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string PRODUCTTAG_POPULAR_MODEL_KEY = "Nop.Bswebapi.pres.producttag.popular-{0}-{1}";

//        public const string PRODUCTTAG_POPULAR_PATTERN_KEY = "Nop.Bswebapi.pres.producttag.popular";
...
//        /// {3} : current store ID
//        /// </remarks>
//        public const string PRODUCT_MANUFACTURERS_MODEL_KEY = "Nop.Bswebapi.pres.product.manufacturers-{0}-{1}-{2}-{3}";

//        public const string PRODUCT_MANUFACTURERS_PATTERN_KEY = "Nop.Bswebapi.pres.product.manufacturers";
...
//        /// {1} : language id
//        /// </remarks>
//        public const string PRODUCT_SPECS_MODEL_KEY = "Nop.Bswebapi.pres.product.specs-{0}-{1}";

//        public const string PRODUCT_SPECS_PATTERN_KEY = "Nop.Bswebapi.pres.product.specs";
...
//        /// {0} : product id
//        /// </remarks>
//        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_KEY = "Nop.Bswebapi.pres.product.hasproductattributes-{0}";

//        public const string PRODUCT_HAS_PRODUCT_ATTRIBUTES_PATTERN_KEY =
//            "Nop.Bswebapi.pres.product.hasproductattributes";
...
//        /// {2} : store id
//        /// </remarks>
//        public const string TOPIC_MODEL_BY_SYSTEMNAME_KEY = "Nop.Bswebapi.pres.topic.details.bysystemname-{0}-{1}-{2}";
...
//        /// {2} : store id
//        /// </remarks>
//        public const string TOPIC_MODEL_BY_ID_KEY = "Nop.Bswebapi.pres.topic.details.byid-{0}-{1}-{2}";
...
//        /// {2} : store id
//        /// </remarks>
//        public const string TOPIC_SENAME_BY_SYSTEMNAME = "Nop.Bswebapi.pres.topic.sename.bysystemname-{0}-{1}-{2}";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string TOPIC_TOP_MENU_MODEL_KEY = "Nop.Bswebapi.pres.topic.topmenu-{0}-{1}";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string TOPIC_FOOTER_MODEL_KEY = "Nop.Bswebapi.pres.topic.footer-{0}-{1}";

//        public const string TOPIC_PATTERN_KEY = "Nop.Bswebapi.pres.topic";
...
//        /// {0} : category template id
//        /// </remarks>
//        public const string CATEGORY_TEMPLATE_MODEL_KEY = "Nop.Bswebapi.pres.categorytemplate-{0}";

//        public const string CATEGORY_TEMPLATE_PATTERN_KEY = "Nop.Bswebapi.pres.categorytemplate";
...
//        /// {0} : manufacturer template id
//        /// </remarks>
//        public const string MANUFACTURER_TEMPLATE_MODEL_KEY = "Nop.Bswebapi.pres.manufacturertemplate-{0}";

//        public const string MANUFACTURER_TEMPLATE_PATTERN_KEY = "Nop.Bswebapi.pres.manufacturertemplate";
...
//        /// {0} : product template id
//        /// </remarks>
//        public const string PRODUCT_TEMPLATE_MODEL_KEY = "Nop.Bswebapi.pres.producttemplate-{0}";

//        public const string PRODUCT_TEMPLATE_PATTERN_KEY = "Nop.Bswebapi.pres.producttemplate";
...
//        /// {0} : topic template id
//        /// </remarks>
//        public const string TOPIC_TEMPLATE_MODEL_KEY = "Nop.Bswebapi.pres.topictemplate-{0}";

//        public const string TOPIC_TEMPLATE_PATTERN_KEY = "Nop.Bswebapi.pres.topictemplate";
...
//        /// {0} : current store ID
//        /// </remarks>
//        public const string HOMEPAGE_BESTSELLERS_IDS_KEY = "Nop.Bswebapi.pres.bestsellers.homepage-{0}";

//        public const string HOMEPAGE_BESTSELLERS_IDS_PATTERN_KEY = "Nop.Bswebapi.pres.bestsellers.homepage";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string PRODUCTS_ALSO_PURCHASED_IDS_KEY = "Nop.Bswebapi.pres.alsopuchased-{0}-{1}";

//        public const string PRODUCTS_ALSO_PURCHASED_IDS_PATTERN_KEY = "Nop.Bswebapi.pres.alsopuchased";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string PRODUCTS_RELATED_IDS_KEY = "Nop.Bswebapi.pres.related-{0}-{1}";

//        public const string PRODUCTS_RELATED_IDS_PATTERN_KEY = "Nop.Bswebapi.pres.related";
...
//        /// {5} : current store ID
//        /// </remarks>
//        public const string PRODUCT_DEFAULTPICTURE_MODEL_KEY =
//            "Nop.Bswebapi.pres.product.detailspictures-{0}-{1}-{2}-{3}-{4}-{5}";

//        public const string PRODUCT_DEFAULTPICTURE_PATTERN_KEY = "Nop.Bswebapi.pres.product.detailspictures";
...
//        /// {5} : current store ID
//        /// </remarks>
//        public const string PRODUCT_DETAILS_PICTURES_MODEL_KEY =
//            "Nop.Bswebapi.pres.product.picture-{0}-{1}-{2}-{3}-{4}-{5}";

//        public const string PRODUCT_DETAILS_TPICTURES_PATTERN_KEY = "Nop.Bswebapi.pres.product.picture";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string PRODUCTATTRIBUTE_PICTURE_MODEL_KEY =
//            "Nop.Bswebapi.pres.productattribute.picture-{0}-{1}-{2}";

//        public const string PRODUCTATTRIBUTE_PICTURE_PATTERN_KEY = "Nop.Bswebapi.pres.productattribute.picture";
...
//        /// {5} : current store ID
//        /// </remarks>
//        public const string CATEGORY_PICTURE_MODEL_KEY = "Nop.Bswebapi.pres.category.picture-{0}-{1}-{2}-{3}-{4}-{5}";

//        public const string CATEGORY_PICTURE_PATTERN_KEY = "Nop.Bswebapi.pres.category.picture";
...
//        /// {5} : current store ID
//        /// </remarks>
//        public const string MANUFACTURER_PICTURE_MODEL_KEY =
//            "Nop.Bswebapi.pres.manufacturer.picture-{0}-{1}-{2}-{3}-{4}-{5}";

//        public const string MANUFACTURER_PICTURE_PATTERN_KEY = "Nop.Bswebapi.pres.manufacturer.picture";
...
//        /// {5} : current store ID
//        /// </remarks>
//        public const string CART_PICTURE_MODEL_KEY = "Nop.Bswebapi.pres.cart.picture-{0}-{1}-{2}-{3}-{4}-{5}";

//        public const string CART_PICTURE_PATTERN_KEY = "Nop.Bswebapi.pres.cart.picture";
...
//        /// {0} : language ID
//        /// </remarks>
//        public const string HOMEPAGE_POLLS_MODEL_KEY = "Nop.Bswebapi.pres.poll.homepage-{0}";
...
//        /// {1} : language ID
//        /// </remarks>
//        public const string POLL_BY_SYSTEMNAME__MODEL_KEY = "Nop.Bswebapi.pres.poll.systemname-{0}-{1}";

//        public const string POLLS_PATTERN_KEY = "Nop.Bswebapi.pres.poll";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string BLOG_TAGS_MODEL_KEY = "Nop.Bswebapi.pres.blog.tags-{0}-{1}";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string BLOG_MONTHS_MODEL_KEY = "Nop.Bswebapi.pres.blog.months-{0}-{1}";

//        public const string BLOG_PATTERN_KEY = "Nop.Bswebapi.pres.blog";
...
//        /// {1} : current store ID
//        /// </remarks>
//        public const string HOMEPAGE_NEWSMODEL_KEY = "Nop.Bswebapi.pres.news.homepage-{0}-{1}";

//        public const string NEWS_PATTERN_KEY = "Nop.Bswebapi.pres.news";
...
//        /// {0} : language ID
//        /// </remarks>
//        public const string STATEPROVINCES_BY_COUNTRY_MODEL_KEY =
//            "Nop.Bswebapi.pres.stateprovinces.bycountry-{0}-{1}-{2}";

//        public const string STATEPROVINCES_PATTERN_KEY = "Nop.Bswebapi.pres.stateprovinces";
...
//        /// {0} : current store ID
//        /// </remarks>
//        public const string AVAILABLE_LANGUAGES_MODEL_KEY = "Nop.Bswebapi.pres.languages.all-{0}";

//        public const string AVAILABLE_LANGUAGES_PATTERN_KEY = "Nop.Bswebapi.pres.languages";
...
//        /// {0} : current store ID
//        /// </remarks>
//        public const string AVAILABLE_CURRENCIES_MODEL_KEY = "Nop.Bswebapi.pres.currencies.all-{0}-{1}";

//        public const string AVAILABLE_CURRENCIES_PATTERN_KEY = "Nop.Bswebapi.pres.currencies";
...
//        /// {1} : true - all attributes, false - only shippable attributes
//        /// </remarks>
//        public const string CHECKOUTATTRIBUTES_EXIST_KEY = "Nop.Bswebapi.pres.checkoutattributes.exist-{0}-{1}";

//        public const string CHECKOUTATTRIBUTES_PATTERN_KEY = "Nop.Bswebapi.pres.checkoutattributes";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string SITEMAP_PAGE_MODEL_KEY = "Nop.Bswebapi.pres.sitemap.page-{0}-{1}-{2}";
...
//        /// {2} : current store ID
//        /// </remarks>
//        public const string SITEMAP_SEO_MODEL_KEY = "Nop.Bswebapi.pres.sitemap.seo-{0}-{1}-{2}";

//        public const string SITEMAP_PATTERN_KEY = "Nop.Bswebapi.pres.sitemap";
...
//        /// {1} : widget zone
//        /// </remarks>
//        public const string WIDGET_MODEL_KEY = "Nop.Bswebapi.pres.widget-{0}-{1}";

//        public const string WIDGET_PATTERN_KEY = "Nop.Bswebapi.pres.widget";
...
//            _cacheManager.RemoveByPattern(MANUFACTURER_NAVIGATION_PATTERN_KEY);
//                //depends on CatalogSettings.ManufacturersBlockItemsToDisplay
//            _cacheManager.RemoveByPattern(VENDOR_NAVIGATION_PATTERN_KEY);
//                //depends on VendorSettings.VendorBlockItemsToDisplay
//            _cacheManager.RemoveByPattern(CATEGORY_NAVIGATION_PATTERN_KEY);
...
//            _cacheManager.RemoveByPattern(PRODUCTS_ALSO_PURCHASED_IDS_PATTERN_KEY);
//                //depends on CatalogSettings.ProductsAlsoPurchasedNumber
//            _cacheManager.RemoveByPattern(PRODUCTS_RELATED_IDS_PATTERN_KEY);
//            _cacheManager.RemoveByPattern(BLOG_PATTERN_KEY); //depends on BlogSettings.NumberOfTags
//            _cacheManager.RemoveByPattern(NEWS_PATTERN_KEY); //depends on NewsSettings.MainPageNewsCount
//            _cacheManager.RemoveByPattern(SITEMAP_PATTERN_KEY); //depends on distinct sitemap settings
