...
namespace BS.Plugin.NopStation.MobileWebApi.Models.DashboardModel
{
    public partial class CustomerInfoModel : BaseNopModel
    {
        ...
        {
            this.AvailableTimeZones = new List<BS.Plugin.NopStation.MobileWebApi.Model.SelectListItem>();
            this.AvailableCountries = new List<BS.Plugin.NopStation.MobileWebApi.Model.SelectListItem>();
            this.AvailableStates = new List<BS.Plugin.NopStation.MobileWebApi.Model.SelectListItem>();
        ...
        public IList<BS.Plugin.NopStation.MobileWebApi.Model.SelectListItem> AvailableCountries { get; set; }

        public bool StateProvinceEnabled { get; set; }
        public bool StateProvinceRequired { get; set; }
        [NopResourceDisplayName("Account.Fields.StateProvince")]
        public int StateProvinceId { get; set; }
        public IList<BS.Plugin.NopStation.MobileWebApi.Model.SelectListItem> AvailableStates { get; set; }
        ...
        public IList<BS.Plugin.NopStation.MobileWebApi.Model.SelectListItem> AvailableTimeZones { get; set; }
