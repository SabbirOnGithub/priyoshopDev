...
namespace Nop.Plugin.Payments.PayPalStandard.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        //custom fields for Priyoshop
        [NopResourceDisplayName("Plugins.Payments.PayPalStandard.Fields.ConversionRate")]
        public decimal ConversionRate { get; set; }
        public bool ConversionRate_OverrideForStore { get; set; }
