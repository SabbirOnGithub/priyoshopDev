...
namespace Nop.Plugin.Payments.PayPalStandard.Controllers
{
    public class PaymentPayPalStandardController : BasePaymentController
    {
        ...
        public ActionResult Configure()
        {
            ...
            //custom field for Priyoshop
            model.ConversionRate = payPalStandardPaymentSettings.ConversionRate;
            ...
            if (storeScope > 0)
            {
                ...
                //custom field for Priyoshop
                model.ConversionRate_OverrideForStore = _settingService.SettingExists(payPalStandardPaymentSettings, x => x.ConversionRate, storeScope);
            }
        ...
        public ActionResult Configure(ConfigurationModel model)
        {
            ...
            payPalStandardPaymentSettings.ConversionRate = model.ConversionRate;
            ...
            //custom field for Priyoshop
            _settingService.SaveSettingOverridablePerStore(payPalStandardPaymentSettings, x => x.ConversionRate, model.ConversionRate_OverrideForStore, storeScope, false);
