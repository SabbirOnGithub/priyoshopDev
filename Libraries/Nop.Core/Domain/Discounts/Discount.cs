...
namespace Nop.Core.Domain.Discounts
{
    ...
    public partial class Discount : BaseEntity
    {
        ...
        private ICollection<Vendor> _appliedToVendors;
        ...
        /// </summary>
        public virtual ICollection<Vendor> AppliedToVendors
        {
            get { return _appliedToVendors ?? (_appliedToVendors = new List<Vendor>()); }
        ...
        public bool IsBulkCoupon
        {
            get
            {
                return !string.IsNullOrWhiteSpace(BulkTrack);
            }
        }

        public LimitationOnOrder LimitationOnOrder {
            get
            {
                return (LimitationOnOrder)LimitationOnOrderId;
            }
            set
            {
                LimitationOnOrderId = (int)value;
            }
        }
        #endregion
    }
