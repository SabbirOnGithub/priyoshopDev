...
namespace Nop.Core.Domain.Orders
{
    ...
    public partial class Order : BaseEntity
    {
        ...
        public int UserAgentTypeId { get; set; }


        public decimal MakeAmount { get; set; } = 0;

        public bool IsMakePayment { get; set; } = false;
        ...
        public UserAgentType UserAgentType
        {
            get
            {
                return (UserAgentType)this.UserAgentTypeId;
            }
            set
            {
                this.UserAgentTypeId = (int)value;
            }
        }
        ...
        public PurchaseOfferUsageHistory PurchaseOfferUsageHistory { get; set; }
