...
namespace Nop.Core.Domain.Customers
{
    public class CustomerSettings : ISettings
    {
        ...
        public bool EnableAffiliate { get; set; }

        public int AffiliatedOrdersPageSize { get; set; }
        ...
        public string SMSGatewaySID { get; set; }

        public int TokenValidationDuration { get; set; }
