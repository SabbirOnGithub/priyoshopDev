...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        private ICollection<ProductRestrictedPaymentMethod> _restrictedPaymentMethods;
        ...
        public virtual ICollection<ProductRestrictedPaymentMethod> RestrictedPaymentMethods
        {
            get { return _restrictedPaymentMethods ?? (_restrictedPaymentMethods = new List<ProductRestrictedPaymentMethod>()); }
            protected set { _restrictedPaymentMethods = value; }
        }

        /// <summary>
        /// Gets or sets the special product cost
        /// </summary>
        public decimal? SpecialProductCost { get; set; }

        /// <summary>
        /// Gets or sets the start date and time of the special product cost
        /// </summary>
        public DateTime? SpecialProductCostStartDateTimeUtc { get; set; }
        /// <summary>
        /// Gets or sets the end date and time of the special product cost
        /// </summary>
        public DateTime? SpecialProductCostEndDateTimeUtc { get; set; }

        public bool VendorInActiveOrDeleted { get; set; }
