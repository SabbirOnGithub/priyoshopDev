...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        protected virtual string[] GetPictures(Product product)
        {
            ...
            {
                var pictureLocalPath = _pictureService.GetPictureUrl(pictures[i]);
        ...
        public virtual string ExportProductsToXml(IList<Product> products)
        {
            ...
            foreach (var product in products)
            {
                ...
                xmlWriter.WriteElementString("SpecialProductCost", null, product.SpecialProductCost.HasValue ? product.SpecialProductCost.ToString() : string.Empty);
                xmlWriter.WriteElementString("SpecialProductCostStartDateTimeUtc", null, product.SpecialProductCostStartDateTimeUtc.HasValue ? product.SpecialProductCostStartDateTimeUtc.ToString() : string.Empty);
                xmlWriter.WriteElementString("SpecialProductCostEndDateTimeUtc", null, product.SpecialProductCostEndDateTimeUtc.HasValue ? product.SpecialProductCostEndDateTimeUtc.ToString() : string.Empty);
        ...
        public virtual byte[] ExportProductsToXlsx(IEnumerable<Product> products)
        {
            var properties = new[]
            {
                ...
                new PropertyByName<Product>("SpecialProductCost", p => p.SpecialProductCost, IgnoreExportPoductProperty(p => p.SpecialProductCost)),
                new PropertyByName<Product>("SpecialProductCostStartDateTimeUtc", p => p.SpecialProductCostStartDateTimeUtc, IgnoreExportPoductProperty(p => p.SpecialProductCostStartDate)),
                new PropertyByName<Product>("SpecialProductCostEndDateTimeUtc", p => p.SpecialProductCostEndDateTimeUtc, IgnoreExportPoductProperty(p => p.SpecialProductCostEndDate)),
        ...
        public virtual byte[] CustomExportProductsToXlsx(IEnumerable<Product> products)
        {
            ...
            var properties = new[]
            {
                new PropertyByName<Product>("ID", p => p.Sku),
                new PropertyByName<Product>("Title", p => p.Name),
                new PropertyByName<Product>("Description", p => p.ShortDescription),
                new PropertyByName<Product>("StockQuantity", p => p.StockQuantity),
                new PropertyByName<Product>("Price", p => string.Format("{0:0.##}", p.Price) + " " + currency),
                new PropertyByName<Product>("Link", p => storeurl +  p.GetSeName(0)),
                new PropertyByName<Product>("Image", p => GetPictures(p)[0])
        ...
        public virtual byte[] ExportVendorsToXlsx(IEnumerable<Vendor> vendors)
        {
            //property array
            var properties = new[]
            {
                new PropertyByName<Vendor>("Id", v => v.Id),
                new PropertyByName<Vendor>("Name", v => v.Name),
                new PropertyByName<Vendor>("Email", v => v.Email),
                new PropertyByName<Vendor>("Description", v => v.Description),
                new PropertyByName<Vendor>("Active", v => v.Active),
                new PropertyByName<Vendor>("IsFreeShipping", v => v.IsFreeShipping)
            };
            return ExportToXlsx(properties, vendors);
        }
