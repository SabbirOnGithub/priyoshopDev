                ...
                for (var iRow = 2; iRow < endRow; iRow++)
                {
                    ...
                    foreach (var property in manager.GetProperties)
                    {
                        switch (property.PropertyName)
                        {
                            ...
                            case "SpecialProductCost":
                                product.SpecialProductCost = property.DecimalValueNullable;
                                break;
                            case "SpecialProductCostStartDateTimeUtc":
                                product.SpecialProductCostStartDateTimeUtc = property.DateTimeNullable;
                                break;
                            case "SpecialProductCostEndDateTimeUtc":
                                product.SpecialProductCostEndDateTimeUtc = property.DateTimeNullable;
                                break;
