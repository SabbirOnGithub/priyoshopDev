...
namespace Nop.Services.Catalog
{
    ...
    public partial class ManufacturerService : IManufacturerService
    {
        ...
        private readonly IRepository<ManufacturerHistory> _manufacturerHistoryRepository;
        ...
        public ManufacturerService(ICacheManager cacheManager,
            ...
            IRepository<ManufacturerHistory> manufacturerHistoryRepository)
        {
            ...
            this._manufacturerHistoryRepository = manufacturerHistoryRepository;
        }
        #endregion
        ...
        public virtual IList<Manufacturer> GetAllManufacturersDisplayedOnHomePage()
        {
        ...
        public virtual IList<Manufacturer> GetProductManufacturersByCategoryId(int categoryId)
        {
        ...
        public IList<Manufacturer> GetManufacturersByIds(int[] ids)
        {
            ...
            var query = _manufacturerRepository.Table.Where(x => ids.Contains(x.Id));
            return query.ToList();
        }
        ...
        /// </summary>
        /// <param name="manufacturerHistory">Manufacturer history</param>
        public virtual void InsertManufacturerHistory(ManufacturerHistory manufacturerHistory)
        {
            if (manufacturerHistory == null)
                throw new ArgumentNullException("manufacturerHistory");

            _manufacturerHistoryRepository.Insert(manufacturerHistory);

            //event notification
            _eventPublisher.EntityInserted(manufacturerHistory);
        }

        /// <summary>
        /// Gets an manufacturer history
        /// </summary>
        /// <param name="manufacturerHistoryId">The manufacturer history identifier</param>
        /// <returns>Manufacturer History</returns>
        public virtual ManufacturerHistory GetManufacturerHistoryById(int manufacturerHistoryId)
        {
            if (manufacturerHistoryId == 0)
                return null;

            return _manufacturerHistoryRepository.GetById(manufacturerHistoryId);
        }

        /// <summary>
        /// Gets an manufacturer history
        /// </summary>
        /// <param name="manufacturerId"> Denotes the id of the manufacturer history is to retrieved</param>
        /// <param name="pageIndex"> Denoted the page-index</param>
        /// <param name="pageSize"> Denoted the page-size</param>
        /// <returns>Manufacturer History</returns>
        public virtual IPagedList<ManufacturerHistory> GetManufacturerHistoriesByManufacturerId(int manufacturerId, int pageIndex,
            int pageSize)
        {
            var query = _manufacturerHistoryRepository.Table;
            query = query.Where(ph => ph.ManufacturerId == manufacturerId);
            query = query.OrderByDescending(ph => ph.CreatedOnUtc);

            return new PagedList<ManufacturerHistory>(query, pageIndex, pageSize);
        }
        ...
        /// </summary>
        /// <param name="manufacturerHistory">The manufacturer history</param>
        public virtual void DeleteManufacturerHistory(ManufacturerHistory manufacturerHistory)
        {
            if (manufacturerHistory == null)
                throw new ArgumentNullException("manufacturerHistory");

            _manufacturerHistoryRepository.Delete(manufacturerHistory);

            //event notification
            _eventPublisher.EntityDeleted(manufacturerHistory);
        }
