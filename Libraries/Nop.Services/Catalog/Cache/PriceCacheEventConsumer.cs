...
namespace Nop.Services.Catalog.Cache
{
        ...
        IConsumer<EntityDeleted<Vendor>>
    {
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string DISCOUNT_VENDOR_IDS_MODEL_KEY = "Nop.totals.discount.vendorids-{0}-{1}-{2}";
        public const string DISCOUNT_VENDOR_IDS_PATTERN_KEY = "Nop.totals.discount.vendorids";
        ...
        public void HandleEvent(EntityUpdated<Setting> eventMessage)
        {
            ...
            _cacheManager.RemoveByPattern(DISCOUNT_VENDOR_IDS_PATTERN_KEY);
