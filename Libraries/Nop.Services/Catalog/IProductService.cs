...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        #region brainstatio
        IList<Product> GetDeletedProductsByVendorId(int vendorId);
        #endregion
        ...
        void AddRestrictedPaymentMethod(ProductRestrictedPaymentMethod method);

        void DeleteRestrictedPaymentMethod(ProductRestrictedPaymentMethod method);

        #endregion

        #region Vendor update products
        IPagedList<Product> SearchVendorUpdateProducts(DateTime fromDate, DateTime toDate, int vendorId = 0,
            int pageIndex = 0,
            int pageSize = int.MaxValue);
        #endregion

        #region Update product request incomplete task
        //Product GetUpdateRequestProductByOriginalId(Product product);
        #endregion
        ...
        ProductHistory GetProductHistoryById(int productHistoryId);

        IPagedList<ProductHistory> GetProductHistoriesByProductId(int productId, int pageIndex, int pageSize);
