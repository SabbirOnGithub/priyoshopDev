...
namespace Nop.Services.Catalog
{
    ...
    public partial interface ICategoryService
    {
        ...
        IPagedList<Category> GetAllCategoriesForApp(string categoryName = "", int storeId = 0,
            int pageIndex = 0, int pageSize = int.MaxValue, bool showHidden = false);
        ...
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>Categories</returns>
        IList<Category> GetAllCategoriesDisplayedOnHomePage(bool showHidden = false, bool ignoreAcl = false);
        ...
        void InsertCategoryHistory(CategoryHistory categoryHistory);

        CategoryHistory GetCategoryHistoryById(int categoryHistoryId);

        IPagedList<CategoryHistory> GetCategoryHistoriesByCategoryId(int categoryId, int pageIndex, int pageSize);

        void DeleteCategoryHistory(CategoryHistory categoryHistory);
