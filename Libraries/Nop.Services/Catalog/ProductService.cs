...
namespace Nop.Services.Catalog
{
    ...
    public partial class ProductService : IProductService
    {
        ...
        public ProductService(ICacheManager cacheManager,
            ...
            IRepository<ProductRestrictedPaymentMethod> productRPMRepository,
            IRepository<ProductHistory> productHistoryRepository)
        {
            ...
            bool? overridePublished = null)
        {
            ...
            return SearchProducts(out filterableSpecificationAttributeOptionIds, false,
                ...
                orderBy, showHidden, overridePublished, false, true, false);
        }
        ...
        public virtual IPagedList<Product> SearchProducts(
            ...
            bool activeVendorOnly = false,
            bool includeEkshopProducts = true)
        {
            ...
            if (_commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            {
                ...
                var pActiveVendorOnly = _dataProvider.GetParameter();
                pActiveVendorOnly.ParameterName = "ActiveVendorOnly";
                pActiveVendorOnly.Value = activeVendorOnly;
                pActiveVendorOnly.DbType = DbType.Boolean;

                var pIncludeEkshopProducts = _dataProvider.GetParameter();
                pIncludeEkshopProducts.ParameterName = "IncludeEkshopProducts";
                pIncludeEkshopProducts.Value = includeEkshopProducts;
                pIncludeEkshopProducts.DbType = DbType.Boolean;
        ...
        #region brainstation
        public virtual IList<Product> GetDeletedProductsByVendorId(int vendorId)
        {
            var query = _productRepository.Table;
            query = query.Where(p => p.VendorId == vendorId);
            query = query.Where(x => x.Deleted);
        ...
        public void AddRestrictedPaymentMethod(ProductRestrictedPaymentMethod method)
        {
            _productRPMRepository.Insert(method);
        }

        public void DeleteRestrictedPaymentMethod(ProductRestrictedPaymentMethod method)
        {
            _productRPMRepository.Delete(method);
        }

        #endregion

        #region Vendor update products
        public virtual IPagedList<Product> SearchVendorUpdateProducts(DateTime fromDate, DateTime toDate, int vendorId = 0,
            int pageIndex = 0,
            int pageSize = int.MaxValue)
        {
            var pVendorId = _dataProvider.GetParameter();
        ...
        #region Update product request incomplete task
        //public virtual Product GetUpdateRequestProductByOriginalId(Product product)
        //{
        //    if (product.Id == 0)
        //        return null;
        ...
        //                p.UpdateRequest &&
        //                p.RequestProductId == product.Id
        //                select p;

        //    if (!query.Any())
        //        return null;

        //    var updateRequestProduct = query.FirstOrDefault();

        //    return updateRequestProduct;
        //}
        #endregion

        #region Products History

        /// <summary>
        /// Inserts a history record for a 
        /// </summary>
        /// <param name="productHistory">Product history</param>
        public virtual void InsertProductHistory(ProductHistory productHistory)
        {
            if (productHistory == null)
                throw new ArgumentNullException("productHistory");

            _productHistoryRepository.Insert(productHistory);

            //event notification
            _eventPublisher.EntityInserted(productHistory);
        }

        /// <summary>
        /// Gets an product history
        /// </summary>
        /// <param name="productHistoryId">The product history identifier</param>
        /// <returns>Product History</returns>
        public virtual ProductHistory GetProductHistoryById(int productHistoryId)
        {
            if (productHistoryId == 0)
                return null;

            return _productHistoryRepository.GetById(productHistoryId);
        }

        /// <summary>
        /// Gets an product history
        /// </summary>
        /// <param name="productId"> Denotes the id of the product history is to retrieved</param>
        /// <param name="pageIndex"> Denoted the page-index</param>
        /// <param name="pageSize"> Denoted the page-size</param>
        /// <returns>Product History</returns>
        public virtual IPagedList<ProductHistory> GetProductHistoriesByProductId(int productId, int pageIndex,
            int pageSize)
        {
            var query = _productHistoryRepository.Table;
            query = query.Where(ph => ph.ProductId == productId);
            query = query.OrderByDescending(ph => ph.CreatedOnUtc);

            return new PagedList<ProductHistory>(query, pageIndex, pageSize);
        }
        ...
        /// </summary>
        /// <param name="productHistory">The product history</param>
        public virtual void DeleteProductHistory(ProductHistory productHistory)
        {
            if (productHistory == null)
                throw new ArgumentNullException("productHistory");
            ...
            //event notification
            _eventPublisher.EntityDeleted(productHistory);
        }
        ...
        public IPagedList<Product> SearchProducts(bool activeVendorOnly, bool includeEkshopProducts, int pageIndex = 0, int pageSize = int.MaxValue, IList<int> categoryIds = null, int manufacturerId = 0, int storeId = 0, int vendorId = 0, int warehouseId = 0, ProductType? productType = null, bool visibleIndividuallyOnly = false, bool markedAsNewOnly = false, bool? featuredProducts = null, decimal? priceMin = null, decimal? priceMax = null, int productTagId = 0, string keywords = null, bool searchDescriptions = false, bool searchManufacturerPartNumber = true, bool searchSku = true, bool searchProductTags = false, int languageId = 0, IList<int> filteredSpecs = null, ProductSortingEnum orderBy = ProductSortingEnum.Position, bool showHidden = false, bool? overridePublished = null)
        {
            ...
            return SearchProducts(out filterableSpecificationAttributeOptionIds, false,
                ...
                priceMin, priceMax, productTagId, keywords, searchDescriptions, searchManufacturerPartNumber, searchSku,
                searchProductTags, languageId, filteredSpecs,
                orderBy, showHidden, overridePublished, false, activeVendorOnly, includeEkshopProducts);
        }
