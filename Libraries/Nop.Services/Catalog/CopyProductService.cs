...
namespace Nop.Services.Catalog
{
    ...
    public partial class CopyProductService : ICopyProductService
    {
        ...
        public virtual Product CopyProduct(Product product, string newName, bool isPublished = true, 
            ...
            decimal newPrice = 0, decimal newProductCost = 0)
        {
            ...
            var skuFirstPart = productCopy.Sku.Substring(0, 2);
            productCopy.Sku = string.Format("{0}{1:D2}-{2}", skuFirstPart, productCopy.VendorId, productCopy.Id);

            if (copyPriceProperties)
            {
                productCopy.Price = product.Price;
                productCopy.OldPrice = product.OldPrice;
                productCopy.ProductCost = product.ProductCost;
                productCopy.SpecialProductCost = product.SpecialProductCost;
                productCopy.SpecialProductCostStartDateTimeUtc = product.SpecialProductCostStartDateTimeUtc;
                productCopy.SpecialProductCostEndDateTimeUtc = product.SpecialProductCostEndDateTimeUtc;
                productCopy.SpecialPrice = product.SpecialPrice;
                productCopy.SpecialPriceStartDateTimeUtc = product.SpecialPriceStartDateTimeUtc;
                productCopy.SpecialPriceEndDateTimeUtc = product.SpecialPriceEndDateTimeUtc;
            }
            else
            {
                productCopy.Price = newPrice;
                productCopy.ProductCost = newProductCost;
            }
