...
namespace Nop.Services.Messages
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        protected virtual string ProductListToHtmlTable(Order order, int languageId, int vendorId)
        {
            ...
            #region brainstation
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).SkuLabel", languageId)));
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).Name", languageId)));
            
            sb.AppendLine(string.Format("<th>{0}</th>", _localizationService.GetResource("Messages.Order.Product(s).Attributes", languageId)));            
            #endregion
            ...
            for (int i = 0; i <= table.Count - 1; i++)
            {
                ...
                sb.AppendLine(string.Format("<td style=\"padding: 0.6em 0.4em;text-align: center;\">{0}</td>", HttpUtility.HtmlEncode(sku)));
                #endregion
                ...
                sb.AppendLine("<td style=\"padding: 0.6em 0.4em;text-align: center;\">");
                //attributes
                if (!String.IsNullOrEmpty(orderItem.AttributeDescription))
                {                    
                    sb.AppendLine(orderItem.AttributeDescription);
            ...
            if (vendorId == 0)
            {
                ...
                if (!String.IsNullOrEmpty(order.CheckoutAttributeDescription))
                {
                    ...
                    sb.AppendLine("<tr><td style=\"text-align:right;\" colspan=\"1\">&nbsp;</td><td colspan=\"5\" style=\"text-align:right\">");
                    #endregion
                ...
                if (displayPaymentMethodFee)
                {
                    ...
                    sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, paymentMethodFeeTitle, cusPaymentMethodAdditionalFee));
                }
                ...
                if (displayTaxRates)
                {
                    foreach (var item in taxRates)
                    {
                        ...
                        sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, taxRate, taxValue));
                    }
                }
                ...
                foreach (var gcuh in gcuhC)
                {
                    ...
                    sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, giftCardText, giftCardAmount));
                }
                ...
                if (order.RedeemedRewardPointsEntry != null)
                {
                    ...
                    sb.AppendLine(string.Format("<tr style=\"text-align:right;\"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td colspan=\"2\" style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{1}</strong></td> <td style=\"background-color: {0};padding:0.6em 0.4 em;\"><strong>{2}</strong></td></tr>", _templatesSettings.Color3, rpTitle, rpAmount));
                }
        ...
        public virtual void AddOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0)
        {
            ...
            tokens.Add(new Token("Order.PaymentStatus", order.PaymentStatus.GetLocalizedEnum(_localizationService, _workContext))); //Add order status token value
        ...
        public virtual string[] GetListOfAllowedTokens()
        {
            ...
            var allowedTokens = new List<string>
            {
                ...
                "%Order.CustomValues%", 
                "%Order.Product(s)%",
                "%Order.PaymentStatus%", //We need extra token for payment status
                "%Order.CreatedOn%",
