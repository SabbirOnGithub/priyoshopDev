...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        void InsertCustomerLedgerDetails(string sql);
        void BalanceTransferFromWallet(Customer customer, long TransferToContactNumber, decimal TransferAmount);
        void MakePaymentForWallet(Customer customer, int OrderID, decimal MakeAmount);
