...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        #region BS-23
        public static readonly PermissionRecord NopStationApiPluginManage = new PermissionRecord { Name = "Admin area.NopStationApiPluginManage", SystemName = "NopStationApiPluginManage", Category = "NopStation" };
        public static readonly PermissionRecord NopStationHompageCategoryPluginManage = new PermissionRecord { Name = "Admin area.NopStationHompageCategoryPluginManage", SystemName = "NopStationHompageCategoryPluginManage", Category = "NopStation" };
        public static readonly PermissionRecord NopStationMobileLoginPluginManage = new PermissionRecord { Name = "Admin area.NopStationMobileLoginPluginManage", SystemName = "NopStationMobileLoginPluginManage", Category = "NopStation" };
        public static readonly PermissionRecord AdvertiseMentSystemManage = new PermissionRecord { Name = "Admin area.AdvertiseMentSystemManage", SystemName = "AdvertiseMentSystemManage", Category = "NopStation" };
        public static readonly PermissionRecord NopStationOnePageCheckoutPluginManage = new PermissionRecord { Name = "Admin area.NopStationOnePageCheckoutPluginManage", SystemName = "NopStationOnePageCheckoutPluginManage", Category = "NopStation" };
        public static readonly PermissionRecord HelpSectionManage = new PermissionRecord { Name = "Admin.Help", SystemName = "HelpSectionManage", Category = "Help" };
        public static readonly PermissionRecord ManageVendorProductsActivity = new PermissionRecord { Name = "Admin area. Manage Vendor Products Activity", SystemName = "ManageVendorProductsActivity", Category = "Catalog" };
        public static readonly PermissionRecord ManagePurchaseOffers = new PermissionRecord { Name = "Admin area. Manage Purchase Offers", SystemName = "ManagePurchaseOffers", Category = "Promo" };
        ...
        public virtual IEnumerable<PermissionRecord> GetPermissions()
        {
            return new[] 
            {
                ...
                AccessClosedStore,
                NopStationApiPluginManage,
                AdvertiseMentSystemManage,
                NopStationMobileLoginPluginManage,
                NopStationHompageCategoryPluginManage,
                NopStationOnePageCheckoutPluginManage,
                HelpSectionManage,
                ManagePurchaseOffers
            };
        }
