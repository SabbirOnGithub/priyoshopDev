...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        #region brainstation
        decimal? GetShoppingCartShippingTotalCustom(IList<ShoppingCartItem> cart, int countryId, int stateProvinenceId);
        decimal? GetShoppingCartShippingTotalCustom(IList<ShoppingCartItem> cart, bool includingTax, int countryId, int stateProvinenceId);
        decimal? GetShoppingCartShippingTotalCustom(IList<ShoppingCartItem> cart, bool includingTax,
        ...
        #region brainstation
        decimal? GetShoppingCartTotalCustom(IList<ShoppingCartItem> cart, bool ignoreRewardPonts = false,
            bool usePaymentMethodAdditionalFee = true,
            int countryId = 0, int stateProvinenceId = 0);
        decimal? GetShoppingCartTotalCustom(IList<ShoppingCartItem> cart,
            out decimal discountAmount, out List<Discount> appliedDiscounts,
            out List<AppliedGiftCard> appliedGiftCards,
            out int redeemedRewardPoints, out decimal redeemedRewardPointsAmount,
            bool ignoreRewardPonts = false, bool usePaymentMethodAdditionalFee = true,
