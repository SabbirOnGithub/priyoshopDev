...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderProcessingService
    {
        ...
        PlaceOrderResult PlaceOrder(ProcessPaymentRequest processPaymentRequest, decimal totalPayableFromWallet = 0);

        PlaceOrderResult PlaceMakepayment(ProcessPaymentRequest processPaymentRequest, decimal MakeAmount = 0);
        /// <summary>
        /// Update order totals
        /// </summary>
