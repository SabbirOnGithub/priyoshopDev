...
namespace Nop.Services.Shipping
{
    ...
    public partial class ShippingService : IShippingService
    {
        ...
        #region brainstation
        public virtual GetShippingOptionResponse GetShippingOptionsCustom(IList<ShoppingCartItem> cart,
            ...
            int countryId = 0, int stateProvinceId = 0, string zip = "")
        {
            ...
            foreach (var srcm in shippingRateComputationMethods)
            {
                ...
                foreach (var shippingOptionRequest in shippingOptionRequests)
                {
                    var getShippingOptionResponse = srcm.GetShippingOptionsCustom(shippingOptionRequest, countryId, stateProvinceId);
