...
namespace Nop.Data.Mapping.Catalog
{
    public partial class ProductMap : NopEntityTypeConfiguration<Product>
    {
        public ProductMap()
        {
            ...
            this.Property(p => p.SpecialProductCost).HasPrecision(18, 4);
            this.Property(p => p.VendorInActiveOrDeleted).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Computed);
