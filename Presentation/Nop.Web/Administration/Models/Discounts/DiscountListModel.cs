...
namespace Nop.Admin.Models.Discounts
{
    public partial class DiscountListModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Promotions.Discounts.List.IncludeBulkCoupon")]
        public bool IncludeBulkCoupon { get; set; }

        [NopResourceDisplayName("Admin.Promotions.Discounts.List.BulkCouponOnly")]
        public bool BulkCouponOnly { get; set; }
    }
}