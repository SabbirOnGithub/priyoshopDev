...
namespace Nop.Admin.Models.Orders
{
    public partial class OrderModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.Orders.Fields.Confident")]
        public bool Confident { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.UserAgentType")]
        public string UserAgentType { get; set; }
        [NopResourceDisplayName("Admin.Orders.Fields.UserAgentType")]
        public int UserAgentTypeId { get; set; }

        [NopResourceDisplayName("Admin.Orders.Fields.GiftProduct")]
