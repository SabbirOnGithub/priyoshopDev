...
namespace Nop.Admin.Models.Orders
{
    public partial class OrderListModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Orders.List.UserAgentType")]
        [UIHint("MultiSelect")]
        public List<int> UserAgentTypeIds { get; set; }
        public IList<SelectListItem> AvailableUserAgentTypes { get; set; }
    }
}