...
namespace Nop.Admin.Models.Affiliates
{
    public partial class AffiliatedOrderListModel : BaseNopModel
    {
        public AffiliatedOrderListModel()
        {
            ...
            AvailableCommisionPaymentStatuses = new List<SelectListItem>();
        }
        ...
        [NopResourceDisplayName("Admin.Affiliates.Orders.CommisionPaymentStatus")]
        public int CommisionPaymentStatusId { get; set; }
        public IList<SelectListItem> AvailableCommisionPaymentStatuses { get; set; }
