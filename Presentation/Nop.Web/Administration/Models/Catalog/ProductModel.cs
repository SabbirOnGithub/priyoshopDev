...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.WarrantyDuration")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.VerifiedByShoppers")]
        public bool VerifiedByShoppers { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.FasterShipping")]
        public bool FasterShipping { get; set; }

        public bool HasUnpublishedRequest { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.TopicId")]
        public int TopicId { get; set; }

        public List<SelectListItem> AvailableTopics { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.SpecialProductCost")]
        [UIHint("DecimalNullable")]
        public decimal? SpecialProductCost { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.SpecialProductCostStartDate")]
        [UIHint("DateTimeNullable")]
        public DateTime? SpecialProductCostStartDateTimeUtc { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.SpecialProductCostEndDate")]
        [UIHint("DateTimeNullable")]
        public DateTime? SpecialProductCostEndDateTimeUtc { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.EkshopOnly")]
