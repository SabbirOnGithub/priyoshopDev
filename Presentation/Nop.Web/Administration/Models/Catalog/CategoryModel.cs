...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class CategoryModel : BaseNopEntityModel, ILocalizedModel<CategoryLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.IsFreeShipping")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.TopicId")]
        public int TopicId { get; set; }
        public IList<SelectListItem> AvailableTopics { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Categories.Fields.VoucherStartsOn")]
        [UIHint("DateTimeNullable")]
        public DateTime? VoucherStartsOn { get; set; }
