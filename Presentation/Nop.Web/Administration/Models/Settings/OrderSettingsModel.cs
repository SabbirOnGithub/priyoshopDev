...
namespace Nop.Admin.Models.Settings
{
    ...
    public partial class OrderSettingsModel : BaseNopModel
    {
        ...
        #region Bs-23
        [NopResourceDisplayName("Admin.Configuration.Settings.Order.BuyOneGetOneEnable")]
        public bool BuyOneGetOneEnable { get; set; }
        public bool BuyOneGetOneEnable_OverrideForStore { get; set; }
        [NopResourceDisplayName("Admin.Configuration.Settings.Order.BuyOneGetOneCategoryId")]
        public int BuyOneGetOneCategoryId { get; set; }
        public bool BuyOneGetOneCategoryId_OverrideForStore { get; set; }
        #endregion
    }
}