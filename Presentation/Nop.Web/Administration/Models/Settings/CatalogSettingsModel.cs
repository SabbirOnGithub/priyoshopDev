...
namespace Nop.Admin.Models.Settings
{
    public partial class CatalogSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.EnableSureThing")]
        public bool EnableSureThing { get; set; }
        public bool EnableSureThing_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.SureThingStartTime")]
        [UIHint("DateTimeNullable")]
        public DateTime? SureThingStartTime { get; set; }
        public bool SureThingStartTime_OverrideForStore { get; set; }
