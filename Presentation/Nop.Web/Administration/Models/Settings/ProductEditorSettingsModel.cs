...
namespace Nop.Admin.Models.Settings
{
    public partial class ProductEditorSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.SpecialProductCost")]
        public bool SpecialProductCost { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.SpecialProductCostStartDate")]
        public bool SpecialProductCostStartDate { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.SpecialProductCostEndDate")]
        public bool SpecialProductCostEndDate { get; set; }
