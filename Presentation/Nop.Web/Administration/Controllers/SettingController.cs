    ...
    public partial class SettingController : BaseAdminController
	{
        ...
        public ActionResult Catalog()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.EnableSureThing_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.EnableSureThing, storeScope);
                model.SureThingStartTime_OverrideForStore = _settingService.SettingExists(catalogSettings, x => x.SureThingStartTime, storeScope);
        ...
        public ActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.EnableSureThing, model.EnableSureThing_OverrideForStore, storeScope, false);
            _settingService.SaveSettingOverridablePerStore(catalogSettings, x => x.SureThingStartTime, model.SureThingStartTime_OverrideForStore, storeScope, false);
        ...
        public ActionResult Order()
        {
            ...
            model.ActiveStoreScopeConfiguration = storeScope;
            model.BuyOneGetOneEnable = orderSettings.BuyOneGetOneEnable;
            model.BuyOneGetOneCategoryId = orderSettings.BuyOneGetOneCategoryId;
            if (storeScope > 0)
            {
                ...
                model.BuyOneGetOneEnable_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.BuyOneGetOneEnable, storeScope);
                model.BuyOneGetOneCategoryId_OverrideForStore = _settingService.SettingExists(orderSettings, x => x.BuyOneGetOneCategoryId, storeScope);
            }
        ...
        public ActionResult Order(OrderSettingsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.BuyOneGetOneEnable, model.BuyOneGetOneEnable_OverrideForStore, storeScope, false);
                _settingService.SaveSettingOverridablePerStore(orderSettings, x => x.BuyOneGetOneCategoryId, model.BuyOneGetOneCategoryId_OverrideForStore, storeScope, false);
