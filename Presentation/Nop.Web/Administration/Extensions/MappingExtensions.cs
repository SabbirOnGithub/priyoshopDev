...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static PurchaseOfferModel ToModel(this PurchaseOffer entity)
        {
            return entity.MapTo<PurchaseOffer, PurchaseOfferModel>();
        }

        public static PurchaseOffer ToEntity(this PurchaseOfferModel model)
        {
            return model.MapTo<PurchaseOfferModel, PurchaseOffer>();
        }

        public static PurchaseOffer ToEntity(this PurchaseOfferModel model, PurchaseOffer destination)
        {
            return model.MapTo(destination);
        }
