    ...
    public partial class ProductController : BasePublicController
    {
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            var model = new ProductDetailsModel
            {
                ...
                DisplayDiscontinuedMessage = (product.VendorInActiveOrDeleted || !product.Published) && _catalogSettings.DisplayDiscontinuedMessageForUnpublishedProducts
            };
            ...
            if (_permissionService.Authorize(StandardPermissionProvider.DisplayPrices))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        decimal finalPriceWithoutDiscountBase = _taxService.GetProductPrice(product, _priceCalculationService.GetFinalPrice(product, _workContext.CurrentCustomer, includeDiscounts: true), out taxRate);
                        ...
                        if(finalPriceWithDiscountBase != oldPriceBase && oldPriceBase != decimal.Zero)
                            model.ProductPrice.Discount = (int)(Math.Round((finalPriceWithoutDiscount - oldPrice) / oldPrice * 100)) + "%";
        ...
        [ChildActionOnly]
        public ActionResult RecentlyViewedProductsBlockInDetailsPage(int? productThumbPictureSize, bool? preparePriceModel)
        {
            if (!_catalogSettings.RecentlyViewedProductsEnabled)
                return Content("");
        ...
        public ActionResult SpecialPriceEndTime(int[] productIds)
        {
            var returnStr = "";
            foreach(var productId in productIds)
            {
                ...
                if (product != null)
                {
                    var endTime = product.SpecialPriceEndDateTimeUtc;
                    if(endTime != null)
                    {
                        returnStr = endTime.ToString();
                        break;
                    }
