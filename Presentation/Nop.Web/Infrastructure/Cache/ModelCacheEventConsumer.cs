...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        #region brainstation
        public const string CATEGORY_MANUFACTURER_NAVIGATION_MODEL_KEY = "Nop.pres.manufacturer.category-navigation-{0}-{1}-{2}-{3}";
        public const string CATEGORY_MANUFACTURER_NAVIGATION_PATTERN_KEY = "Nop.pres.manufacturer.category-navigation";        
        #endregion
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string CATEGORY_MEGAMENU_MODEL_KEY = "Nop.pres.category.megamenu-{0}";
        public const string CATEGORY_MEGAMENU_PATTERN_KEY = "Nop.pres.category.megamenu";
        ...
        public void HandleEvent(EntityInserted<Language> eventMessage)
        {
            ...
            #region brainstation
            _cacheManager.RemoveByPattern(CATEGORY_MANUFACTURER_NAVIGATION_PATTERN_KEY);
            #endregion
        }
        ...
        public void HandleEvent(EntityUpdated<Setting> eventMessage)
        {
            ...
            #region brainstation
            _cacheManager.RemoveByPattern(CATEGORY_MANUFACTURER_NAVIGATION_PATTERN_KEY);
            _cacheManager.RemoveByPattern(CATEGORY_MEGAMENU_PATTERN_KEY);
            #endregion
        }
