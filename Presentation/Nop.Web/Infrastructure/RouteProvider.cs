...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("ProductSearchCustom",
                            "searchproduct/",
                            new { controller = "Catalog", action = "SearchProductCustom" },
                            new[] { "Nop.Web.Controllers" });
            ...
            //   routes.MapLocalizedRoute("MakePayment",
            //     "onepagecheckout",
            //     new { controller = "Nop.Plugin.Misc.OnePageCheckOut.Controllers", action = "MakePaymentCheckout" },
            ...
            routes.MapLocalizedRoute("MakePayment",
                         "makepayment/",
                         new { controller = "MiscOnePageCheckOut", action = "MakePaymentCheckout" },
                         new[] { "Nop.Plugin.Misc.OnePageCheckOut.Controllers" });
            ...
            routes.MapLocalizedRoute("CompletedMakePayment",
                         "checkout/CompletedMakePayment/{orderId}",
                         new { controller = "Checkout", action = "CompletedMakePayment", orderId = UrlParameter.Optional },
                         new { orderId = @"\d+" },
                         new[] { "Nop.Web.Controllers" });
            ...
            //sale with us
            routes.MapLocalizedRoute("SellWithUs",
                            "sellwithus",
                            new { controller = "Common", action = "SaleWithUs" },
                            new[] { "Nop.Web.Controllers" });


            routes.MapLocalizedRoute("Nop.Plugin.Misc.ProductDetailsById.Details",
                            "ProductFind/{productId}",
                             new { controller = "Product", action = "ProductDetails" },
                             new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("Nop.Plugin.Misc.ProductsByVendorId",
                            "ProductsByVendorId/{vendorId}",
                             new { controller = "Catalog", action = "Vendor" },
                             new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("CustomerAffiliatedOrders",
                           "affiliate/orders",
                           new { controller = "Affiliate", action = "Orders" },
                           new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("CustomerAffiliateInfo",
                            "affiliate/info",
                            new { controller = "Affiliate", action = "Info" },
                            new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("CustomerWallet",
                            "customer/wallet",
                            new { controller = "Customer", action = "Wallet" },
                            new[] { "Nop.Web.Controllers" });


            routes.MapLocalizedRoute("CreateWallet",
                          "customer/CreateWallet",
                          new { controller = "Customer", action = "CreateWallet" },
                          new[] { "Nop.Web.Controllers" });

            routes.MapLocalizedRoute("CheckWalletOTP",
                    "customer/CheckWalletOTP",
                    new { controller = "Customer", action = "CheckWalletOTP" },
                    new[] { "Nop.Web.Controllers" });


            routes.MapRoute("LoginStep2",
                             "loginStep2",
                             new { controller = "Customer", action = "LoginStep2" },
                             new[] { "Nop.Web.Controllers" });
            #endregion

            #region priyoshop
            //routes.MapRoute("FlashSale",
            //                "ordhekdam",
            //                 new { controller = "SureThing", action = "Index" },
            //                 new[] { "Nop.Web.Controllers" });

            routes.MapRoute("HighVoltageCashback",
                            "high-voltage-cashback",
                             new { controller = "SureThing", action = "Index" },
                             new[] { "Nop.Web.Controllers" });

            routes.MapRoute("EIDFest",
                            "eidfest",
                             new { controller = "CustomPage", action = "Index" },
                             new[] { "Nop.Web.Controllers" });

            routes.MapRoute("KaziNKaziTea",
                            "kazi-kazi-tea-estate-ltd-home",
                             new { controller = "KaziNKaziTea", action = "Index" },
                             new[] { "Nop.Web.Controllers" });

            routes.MapRoute("BrandWeek",
                "brandweek",
                new { controller = "BrandWeek", action = "Index" },
                new[] { "Nop.Web.Controllers" });
            #endregion
        }
