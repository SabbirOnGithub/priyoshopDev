...
namespace Nop.Web.Models.ShoppingCart
{
    public partial class ShoppingCartModel : BaseNopModel
    {
        public ShoppingCartModel()
        {
            ...
            GiftItem = new ShoppingCartItemModel();
        }
        ...
        public bool IsBuyOneGetOneOfferActivated { get; set; }
        public bool IsActivatedBuyOneGetOne { get; set; }
        public string BuyOneGetOneDiscountAmount { get; set; }
        public string BuyOneGetOneDiscountMessage { get; set; }
        public string BuyOneGetOneDiscountOfferUrl { get; set; }

        public ShoppingCartItemModel GiftItem { get; set; }
        public bool AvailGiftItem { get; set; }
