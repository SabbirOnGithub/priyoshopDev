...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<ProductUnpublishRequestByVendorService>().As<IProductUnpublishRequestByVendorService>().SingleInstance();
            builder.RegisterType<MobileLoginCustomerService>().As<IMobileLoginCustomerService>().InstancePerLifetimeScope();

            builder.RegisterType<CustomerLedgerMasterService>().As<ICustomerLedgerMasterService>().InstancePerLifetimeScope();
            builder.RegisterType<CustomerLedgerDetailService>().As<ICustomerLedgerDetailService>().InstancePerLifetimeScope();
            builder.RegisterType<MakePaymentService>().As<IMakePaymentService>().InstancePerLifetimeScope();
            #endregion
